...
winstonLoggerServices.warn = winston.createLogger({
  level: "warn",
...
winstonLoggerServices.success = winston.createLogger({
  level: "info",
  format: winston.format.combine(
    winston.format.splat(),
    winston.format.simple(),
...
winstonLoggerServices.error = winston.createLogger({
  level: "error",
  format: winston.format.combine(
    winston.format.splat(),
    winston.format.simple(),
...
module.exports = winstonLoggerServices;
